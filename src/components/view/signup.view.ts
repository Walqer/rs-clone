...
class SignUpView {
    render(): HTMLFormElement {
        ...
        const name = new Control<HTMLInputElement>('input', 'auth__form-input', 'input-text');
        ...
        const passRepit = new Control<HTMLInputElement>('input', 'auth__form-input', 'input-text');
